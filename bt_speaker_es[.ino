...
const char* ssid = "motoedge60fusion_8370";
const char* password = "Ascii@008";
const char* fileURL  = "http://10.210.110.197:8000/response.wav";
const char* filePath = "/response.wav";
const char* btDeviceName = "SoundDrum 1";

#define I2S_WS 25
#define I2S_SD 34
#define I2S_SCK 33
#define SAMPLE_RATE 16000
#define TARGET_SIZE 524288/10
...
void setup() {
    ...
    if (WiFi.status() == WL_CONNECTED) {
        HTTPClient http;
        http.begin("http://10.210.110.197:8000/upload");
